		...
		<div class="btn-group">
			<a class="btn btn-primary">
                ...
                if(isset($_SESSION['teacher'])) {
					...
					echo '<img src="'.SERVER.'/assets/img/authority/hasansir.jpg" alt="authority propic" style="border-radius: 2px;width: 17px;height: 18px;" />', '<span>   '.$_SESSION['authority'].'</span>';
				} ?>
			</a>
